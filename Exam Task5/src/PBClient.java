...
public class PBClient {	
	...
	void create_main_gui() {
		...
		jb_getbyno.addActionListener(new GetbynoButtonListener());
	...
	class UpdateButtonListener implements ActionListener {
		public void actionPerformed(ActionEvent ev) {
			...
			try {
				...
				mesg = new SPBMessage("UPDATE",user,pwd,pbe,null);
				oos.writeObject(mesg);
				reply_m = (SPBMessage) ois.readObject();
				String m = reply_m.reply_msg;
	...
	class DeleteButtonListener implements ActionListener {
		public void actionPerformed(ActionEvent ev) {
			...
			try {
				...
				mesg = new SPBMessage("DELETE",user,pwd,pbe,null);
				oos.writeObject(mesg);
				reply_m = (SPBMessage) ois.readObject();
				String m = reply_m.reply_msg;
	...
	class GetbynoButtonListener implements ActionListener {
		public void actionPerformed(ActionEvent ev) {
			SPBMessage mesg, reply_m;
			PhonebookEntry pbe = new PhonebookEntry();
			...
			try {
				...
				mesg = new SPBMessage("GETBYRECNO",user,pwd,pbe,null);
				oos.writeObject(mesg);
				reply_m = (SPBMessage) ois.readObject();
				String m = reply_m.reply_msg;
				PhonebookEntry pbe1 = reply_m.entry;
	...
	class LogoffButtonListener implements ActionListener {
		public void actionPerformed(ActionEvent ev) {
			...
			try {
				...
				mesg = new SPBMessage("LOGOFF",user,pwd,pbe,null);
				oos.writeObject(mesg);
				reply_m = (SPBMessage) ois.readObject();
				String m = reply_m.reply_msg;
				if (m.equals("LOGOFF success")) {
					System.out.println("LOGOUT Successfully, Terminating Client");
					System.exit(0);
				}
				else{
